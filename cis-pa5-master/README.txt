...
The library includes numpy >= 1.15, matplotlib >= 2.2.3


---------------how to use-----------------------
Running ProgrammingAssigment5.py will automatically input dataset from A to K and return you the results in the ./OUTPUT/*.txt files 


--------------------------------------
           Main  Functions
--------------------------------------ProgrammingAssignment5.py
Input:	/	
Output: ./OUTPUT/*.txt# automatically import input files in the data directory and output results for PA5 as *.txt files for each test set 					--------------------------------------		ReadInput.py
Input:	/	
Output: /# Define ReadData(),  ReadData1(),  ReadMesh(), ReadModes() functions							
--------------------------------------	ReadData()
...
# Read in 'Problem5Modes.txt' file in the data directory, return xyz coordinates of vertices in CT coordinates of mode 0 to 6		
